...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-[72] text-[#1f3f73] drop-shadow-[0_18px_30px_rgba(15,23,42,0.22)] transition hover:translate-y-[-2px] hover:opacity-90 sm:bottom-6 sm:right-6"
    >
