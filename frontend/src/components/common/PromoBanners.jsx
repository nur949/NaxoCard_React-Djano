      ...
      <Card className="overflow-hidden bg-secondary text-secondary-foreground">
        <div className="grid items-center gap-5 p-6 sm:grid-cols-[1fr_180px]">
          <div>
            ...
            <h2 className="text-2xl">Member deals every week</h2>
            <p className="mt-2 text-sm text-secondary-foreground/75">Save more on trending essentials and seasonal drops.</p>
      ...
      <Card className="overflow-hidden">
        <div className="grid items-center gap-5 p-6 sm:grid-cols-[1fr_180px]">
          <div>
            ...
            <h2 className="text-2xl">Fast checkout, protected orders</h2>
            <p className="mt-2 text-sm text-muted-foreground">Stripe test checkout, tracked order status, and clear returns.</p>
